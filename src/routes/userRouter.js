...
userRoutes
	...
	.patch('/settings', checkLoggedIn, avatarsUpload.array('files'), updateUserDetails) //Access for logged-in users and only account owner can access the setting page
